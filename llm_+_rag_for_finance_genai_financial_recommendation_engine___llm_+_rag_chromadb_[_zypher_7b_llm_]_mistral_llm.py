# -*- coding: utf-8 -*-
"""LLM + RAG for Finance - GenAI Financial Recommendation Engine | LLM + RAG ChromaDB [ Zypher 7B LLM ] Mistral LLM.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KjuDh3_NEsB5KKDvO68P6tymPNCtnjEM
"""
...
# Check if CUDA is available before attempting quantization
if cuda.is_available():
    model = transformers.AutoModelForCausalLM.from_pretrained(
        model_id,
        trust_remote_code=True,
        config=model_config,
        quantization_config=bnb_config, # Use quantization if GPU is available
        device_map='auto',
    )
else:
    # Load the model without quantization if no GPU is found
    model = transformers.AutoModelForCausalLM.from_pretrained(
        model_id,
        trust_remote_code=True,
        config=model_config,
    ...
    print("Warning: No GPU found. Loading model without quantization.")
